// Import commentato per il primo test: Firebase richiede un progetto
// configurato (google-services.json / GoogleService-Info.plist su
// mobile, VAPID key su web) o l'app si blocca all'avvio. Riabilitalo
// insieme alla riga più sotto quando avrai configurato Firebase.
...
Future<void> main() async {
  ...
  // Commentato per il primo test (vedi nota sull'import più sopra).
  // Richiede gli scaffold nativi (android/, ios/) generati con
  // `flutter create .` e i file di configurazione Firebase per
  // piattaforma (google-services.json / GoogleService-Info.plist, o
  // l'equivalente web) — vedi README per i passaggi di setup completo.
